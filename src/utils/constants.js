...
export const MODAL_ROOM_SETTING = 'MODAL_ROOM_SETTING';
export const MODAL_DM_SETTING = 'MODAL_DM_SETTING';
...
export const MODAL_LEAVE_ROOM = 'MODAL_LEAVE_ROOM';
export const MODAL_DELETE_ROOM = 'MODAL_DELETE_ROOM';
export const MODAL_CHANNEL_DETAIL = 'MODAL_CHANNEL_DETAIL';
