  ...
  >
    <g data-name="Layer 2">
      <g data-name="Layer 3">
        ...
        <path fill="#0ba1e6" d="M1 12C1 4 4 1 12 1s11 3 11 11-3 11-11 11S1 20 1 12"></path>
        <path
          fill="#fff"
          d="M17 7.32H7A1.68 1.68 0 0 0 5.28 9v6A1.68 1.68 0 0 0 7 16.68h1v1.92l1.21-1.92H17A1.68 1.68 0 0 0 18.72 15V9A1.68 1.68 0 0 0 17 7.32Z"
        ></path>
        <path
          fill="#005db1"
          d="M8.4 13.2A1.2 1.2 0 1 1 9.6 12a1.2 1.2 0 0 1-1.2 1.2Zm3.6 0a1.2 1.2 0 1 1 1.2-1.2 1.2 1.2 0 0 1-1.2 1.2Zm3.6 0a1.2 1.2 0 1 1 1.2-1.2 1.2 1.2 0 0 1-1.2 1.2Z"
        ></path>
      </g>
    </g>
  </svg>
...
export const VNFlagIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const CNFlagIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const USFlagIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const KRFlagIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
  ...
  >
    ...
    <g transform="rotate(-56.3099325)">
      ...
      <path
        fill="#0e4896"
        d="M0,390.8c-41.4,0-75,33.6-75,75s33.6,75,75,75s75,33.6,75,75c0,41.4-33.6,75-75,75c-82.8,0-150-67.2-150-150
...
export const THFlagIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const JPFlagIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
