...
import { MODAL_DELETE_ROOM, MODAL_DM_SETTING } from '~/utils/constants';
...
import styles from './DirectMessageSetting.module.scss';
import MenuItem from './MenuItem';

const cx = classNames.bind(styles);

const DirectMessageSetting = () => {
  const views = {
    overview: OverView,
    roles: Role,
  };
  ...
  const isModalOpen = isOpen & (modalType === MODAL_DM_SETTING);
